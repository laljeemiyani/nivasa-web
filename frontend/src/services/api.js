...
export const residentAPI = {
  ...
  getFamilyMembers: () => apiClient.get('/family-members'),
  addFamilyMember: (data) => apiClient.post('/family-members', data),
  updateFamilyMember: (memberId, data) => apiClient.put(`/family-members/${memberId}`, data),
  deleteFamilyMember: (memberId) => apiClient.delete(`/family-members/${memberId}`),
