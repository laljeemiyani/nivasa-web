    ...
    return (
        <div className="space-y-6">
            ...
            <div className="rounded-2xl bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 p-6 shadow-lg">
                <h1 className="text-3xl font-extrabold text-white">Resident Management</h1>
                <p className="text-indigo-100">Manage resident registrations and approvals</p>
            </div>
                ...
                <CardContent>
                                    ...
                                    <td className="border border-gray-300 px-4 py-2">
                                        <Dropdown
                                            trigger={
                                                <Button
                                                    size="sm"
                                                    className="rounded-lg bg-gradient-to-r from-indigo-500 to-purple-500 text-white shadow-md hover:from-indigo-600 hover:to-purple-600 transition-all"
                                                >
                                                    Actions
                                                    <svg
                    ...
                    <div className="mt-4 flex justify-center space-x-2">
                        <Button
                            ...
                            disabled={page === 1}
                            size="sm"
                            className="rounded-lg bg-gray-200 text-gray-700 hover:bg-gray-300"
                        >
                            Previous
                        </Button>
            ...
            <Modal isOpen={modalOpen} onClose={closeModal} size="md">
                ...
                <ModalFooter>
                    <Button
                        ...
                        className="rounded-lg bg-gradient-to-r from-green-500 to-emerald-600 text-white px-5 py-2 shadow-md hover:from-green-600 hover:to-emerald-700 transition-all"
                    >
                        {actionLoading ? 'Processing...' : 'Confirm'}
                    </Button>
                    <Button
                        onClick={closeModal}
                        className="ml-2 rounded-lg border border-gray-300 bg-white text-gray-700 px-5 py-2 hover:bg-gray-100 transition-all"
                    >
                        Cancel
                    </Button>
                </ModalFooter>
