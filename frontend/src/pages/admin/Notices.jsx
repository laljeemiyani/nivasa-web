...
const AdminNotices = () => {
    ...
    return (
        <div className="space-y-6">
            {/* Gradient Header */}
            <div className="rounded-2xl bg-gradient-to-r from-purple-600 via-pink-500 to-red-500 p-6 shadow-lg">
                <h1 className="text-3xl font-bold text-white">Notice Management</h1>
                <p className="text-cyan-100">Create and manage society notices</p>
            </div>

            <div className="flex justify-end">
                <Button
                    onClick={openCreateModal}
                    className="bg-gradient-to-r from-purple-600 via-pink-500 to-red-500 hover:from-purple-700 hover:via-pink-600 hover:to-red-600 text-white shadow-md"
                >
                    Create Notice
                </Button>
            </div>
                    ...
                    {loading ? (
                        ...
                        <div className="overflow-x-auto">
                            <table className="w-full table-auto border-collapse border border-gray-200 rounded-xl overflow-hidden">
                                <thead>
                                <tr className="bg-gradient-to-r from-purple-50 via-pink-50 to-red-50 text-gray-700">
                                ...
                                <tbody>
                                {notices.map((notice) => (
                                    <tr key={notice._id} className="hover:bg-gradient-to-r hover:from-purple-50 hover:via-pink-50 hover:to-red-50 transition">
                                        ...
                                        <td className="border border-gray-300 px-4 py-2 space-x-2">
                                            <Button
                                                ...
                                                className="bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-600 hover:from-blue-600 hover:via-indigo-600 hover:to-purple-700 text-white shadow-md"
                                                size="sm"
                                            >
                                                View
                                            </Button>
                                            <Button
                                                ...
                                                className="bg-gradient-to-r from-yellow-400 via-orange-500 to-red-500 hover:from-yellow-500 hover:via-orange-600 hover:to-red-600 text-white shadow-md"
                                                size="sm"
                                            >
                                                Edit
                                            </Button>
                                            <Button
                                                ...
                                                className="bg-gradient-to-r from-red-500 via-pink-500 to-rose-600 hover:from-red-600 hover:via-pink-600 hover:to-rose-700 text-white shadow-md"
                                                size="sm"
                                            >
                                                Delete
                                            </Button>
                ...
                <ModalFooter>
                    {modalMode !== 'view' && (
                        <Button
                            ...
                            className="rounded-2xl bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 p-6 shadow-lg"
                        >
