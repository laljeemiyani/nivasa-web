...
import { Loader2, Plus, Search, AlertCircle, Trash2, Edit, Eye, FileText } from 'lucide-react';
              ...
              {modalMode !== 'view' && (
                <div className="space-y-2">
                  ...
                  <FileUpload
                    ...
                    showPreview={true}
                  />
                  <p className="text-xs text-gray-500">Upload images or documents related to your complaint</p>
                </div>
              )}
